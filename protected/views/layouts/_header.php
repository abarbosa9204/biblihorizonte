<!-- Navbar Start -->
<nav class="navbar navbar-expand-lg bg-dark text-white navbar-light shadow sticky-top p-0">
    <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        <img class="img-fluid p-1" src="<?php echo Yii::app()->baseUrl; ?>/images/Fundacion_Universitaria_Horizonte.png" alt="Horizonte" style="height: 45px;">
